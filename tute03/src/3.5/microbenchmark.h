 ...
 * 4. The time it takes each of the containers to lookup n with std::find() should be recorded and
 * stored.
 * 4. Steps 1 - 4 should be repeated n_repetitions times.
 * 5. Return a `timings` struct, where each member is the sum of that container's timings /
 * n_repetitions.
 *
